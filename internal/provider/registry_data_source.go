...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-appstore/internal/datasource_registry"
...
const read_ds_registry = "/apps/appstore.eda.nokia.com/v1/registries/{name}"
...
func (d *registryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_registry, map[string]string{
