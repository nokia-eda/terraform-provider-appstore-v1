...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-appstore/internal/datasource_catalog"
...
const read_ds_catalog = "/apps/appstore.eda.nokia.com/v1/catalogs/{name}"
...
func (d *catalogDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_catalog, map[string]string{
...
func (r *catalogDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
