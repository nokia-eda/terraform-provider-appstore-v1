...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-appstore/internal/datasource_app_installer"
...
const read_ds_appInstaller = "/workflows/v1/appstore.eda.nokia.com/v1/appinstallers/{name}"

var (
	_ datasource.DataSource              = (*appInstallerDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*appInstallerDataSource)(nil)
)
...
func (d *appInstallerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_app_installer.AppInstallerDataSourceSchema(ctx)
}

func (d *appInstallerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_app_installer.AppInstallerModel
	...
	err = d.client.GetByQuery(ctx, read_ds_appInstaller, map[string]string{
...
func (r *appInstallerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
