...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-appstore/internal/eda/utils"
...
var _ provider.Provider = (*appstoreProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &appstoreProvider{version: ver}
	}
}
...
func (p *appstoreProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *appstoreProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "appstore-v1"
	resp.Version = p.version
}

func (p *appstoreProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewAppInstallerDataSource,
		NewAppInstallerListDataSource,
		NewCatalogDataSource,
		NewCatalogListDataSource,
...
func (p *appstoreProvider) Resources(ctx context.Context) []func() resource.Resource {
